...
v5k <- "SomaScan_V4.0_5K_Annotated_Content_20210616.xlsx" |>
  ...
  dplyr::select(SeqId,  # do not need CCC here; covered 7k
                serum_5k_to_7k  = "Serum Scalar v4.0 to v4.1",
                plasma_5k_to_7k = "Plasma Scalar v4.0 to v4.1")

v7k <- "SomaScan_V4.1_7K_Annotated_Content_20240214.xlsx" |>
  readxl::read_xlsx(skip = n) |>
  dplyr::select(SeqId,
...
v11k <- "SomaScan_V5.0_11K_Annotated_Content_20240214.xlsx" |>
  readxl::read_xlsx(skip = n) |>
  dplyr::select(SeqId,
...
# this is calculated here, but one day may come from file
